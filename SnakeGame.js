...
//controle dir
document.addEventListener("keydown",dirControle)
 function dirControle(e){
...
function draw(){
  ...
  for( var i = 0;i < snake.length;i++){
	...
	drawFood(food.x,food.y);//drawFood function call
    // snake head
	var snakeX = snake[0].x;
	var snakeY = snake[0].y;
	
	if(snakeX<0 || snakeY<0 || snakeX >= cvs.width/snakeW ||
	snakeY>=cvs.height/snakeH /*|| collision (newHead,snake)*/)
	{
		//clearInterval(game);
		alert("Game Over");
	}
